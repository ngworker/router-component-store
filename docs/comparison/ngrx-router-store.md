...
The following table lists NgRx Router Store selectors and their Router Component Store counterparts.
...
Router Component Store synchronizes router state the following router events.
